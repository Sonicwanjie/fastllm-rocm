...
namespace fastllm {
    ...
    struct AliveThreadPool {
        std::pair <int, int> curActivateThreadInterval; // è®¾å®šå½“å‰æ¿€æ´» [curActivateThreadInterval.first, curActivateThreadInterval.second) çš„çº¿ç¨‹  
    ...
    // [n, m, k] -> [m, n, k], ä»¥kä¸ªå…ƒç´ ä¸ºå•ä½åšè½¬ç½®   
