...
namespace fastllm {
    ...
    protected:
        ...
        // Per-layer input (PLE - Per-Layer Embeddings)
        int hidden_size_per_layer_input = 0; // 0 = disabled
        int num_kv_shared_layers = 0;
        Data perLayerInputData; // cached per-layer input embeddings [batch, seq, num_layers, hidden_size_per_layer_input]
