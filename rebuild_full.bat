...
echo [1/8] Compiling fastllm.cpp...
...
echo [3/8] Compiling tokenizer.cpp...
...
echo [4/8] Compiling template.cpp...
...
echo [5/8] Compiling basellm.cpp...
...
echo [7/8] Compiling gguf.cpp + gguf-adapter.cpp...
